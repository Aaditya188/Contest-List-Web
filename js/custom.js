...
const apiURL = `https://mighty-temple-90200.herokuapp.com/https://clist.by:443/api/v2/contest/?username=prakashaaditya&api_key=edf8ce5b44f4d511928b91c8b5a3d09ca5953522&format=json&order_by=start`;
...
function display() {
          ...
          .btnnewmode {
            ...
            .btnnewmode:hover {
              background-color: RoyalBlue;
					...
					<a class="contest btn btn-lg btn-light mx-4 my-3">
						<div class="left">
	...
	if (inner === ``) {
		tc.innerHTML = `
			...
			<p id="load2">Please Select a Platform to get Contest list</p>
			<p id="load3">Till, We have nothing to show you!</p>
		`
	}
	btn.disabled = false;
}
...
function opennew(urlforcontest){
    window.open(urlforcontest, '_blank');
}

function clipboardcontent(contestname, urlforcontest){
    navigator.clipboard.writeText(contestname +" : "+ urlforcontest);
}
